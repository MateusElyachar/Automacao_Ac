...
void loop()
{
  ...
  Serial.println("Se deseja desligar o LG e ligar o TLC digite a");
  Serial.println("Se deseja desligar o TCL e ligar o LG digite b");
  Serial.println("Se deseja Resetar o ESP digite c");
