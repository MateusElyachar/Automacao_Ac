...
int ar_ligado = 2;
int emergencia = 0; // se ocorreu uma situação que a temperatura superou 27 graus essa variavel vira 1
...
void loop()
{
  ...
  Serial.println("Se deseja desligar o LG e ligar o TLC digite 1");
  Serial.println("Se deseja desligar o TCL e ligar o LG digite 2");
  Serial.println("Se deseja Resetar o ESP digite 3");

  //while (Serial.available() == 0) {  // Wait for user input
  //}
  char decisao = Serial.read(); 
 ...
 //   decisao = 0;
  ...
  if(temp >26 && contador - tempo_agora > 600){
    emergencia = 1;
    tempo_agora = contador;
    AC_TCL_Activate();
    Ac_Activate();
    ar_ligado = 12;
  }

  else if(temp < 26 && emergencia == 1 && contador - tempo_agora > 600){
    emergencia = 0;
    Ac_Activate();
    AC_TCL_Power_down();
    contador = 0;
